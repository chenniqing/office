...
public class PdfUtils {
	 ...
	 * @throws IOException
	 */
	public static void download(ByteArrayOutputStream bos, String fileName) throws IOException {
	 ...
	 * 设置水印
	 * @param reader
	 * @param obj       水印内容，可以是纯英文文字，如果是中文的话，必须使用cn.javaex.office.common.entity.Font
	 * @param destPath
	 * @throws Exception 
	 */
